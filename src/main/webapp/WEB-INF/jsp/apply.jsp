...
<script type="text/javascript">
		...
		$("#applyForm").validate({
			...
			submitHandler : function() {
				...
				$.ajax({
							...
							dataType : "text",
							type : "post",
							url : "${pageContext.request.contextPath}/applySubmit.do",
							success : function() {
	...
	function  Apply_Days(){  
		...
		if(begin!=null&&begin!=""&&end!=null&&end!=""){
			document.getElementById("apply").value = DateDiff(begin,end);
		}
	   }  
						...
						<table width="90%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td align="left"><input type="text" name="username"
									value="${user2.username}" id="username"
									readonly="readonly" /> <input type="hidden" name="uid"
									value="${user2.id}" /></td>
							</tr>
							<tr>
								<td align="right" width="30%">开始时间：</td>
								<td align="left"><input type="text" name="begin"
									id="begin" style="width: 171px;" class="Wdate"
									onClick="WdatePicker()" onblur="Apply_Days()" /> <span
									style="color: red;">*</span></td>
							</tr>
							<tr>
								<td align="right" width="30%">结束时间：</td>
								<td align="left"><input type="text" name="end"
									id="end" style="width: 171px;" class="Wdate"
									onClick="WdatePicker()" onblur="Apply_Days()" /> <span
									style="color: red;">*</span></td>
							</tr>
							<tr>
								<td align="right" width="30%">请假天数：</td>
								<td><input type="text" name="day" id="apply"
							...
							<tr>
								...
								<td align="left"><select name="approver">
							...
							<tr>
								<td align="center" colspan="2"><input type="submit"
									value="提交申请" /> <input type="button" value="返回"
									onclick="goback(${user2.id})" /></td>
							</tr>
